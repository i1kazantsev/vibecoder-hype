...
const COLOR_MAP = {
    ...
    'f': '#ffdbb5', // Телесный цвет кожи Вайбкодера
    'h': '#6b21a8', // Фиолетовый (худи Вайбкодера)
    'j': '#9333ea', // Светло-фиолетовый (худи блик)
    'r': '#ef4444', // Красный
};

// 1. Вайбкодер (В худи, очках-визоре и с наушниками) - Бег Кадр 1
...
// Вайбкодер - Бег Кадр 2 (ноги и руки в другой фазе)
...
// Вайбкодер - Кадр Столкновения (боль, шок, очки косятся)
